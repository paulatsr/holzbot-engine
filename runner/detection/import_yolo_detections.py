...
from runner.ui_export import record_json, record_text
...
EXPORTS_DIR = Path("export_objects/exports")  # doar pentru cleanup inițial
CONF = 0.5   # 0..1
OVERLAP = 30 # 0..100
...
def clear_exports_folder():
    """Șterge tot din export_objects/exports ca să nu rămână mizerie veche."""
...
def main():
    ...
    if not API_KEY:
        msg = "[ERROR] ROBOFLOW_API_KEY lipsește (set ROBOFLOW_API_KEY în env)"
        print(msg)
...
if __name__ == "__main__":
    ...
    if not plans_env:
        ...
        for plan_dir in plans:
            ...
            print(f"\n================= PLAN (import_yolo_detections): {plan_path} =================")
